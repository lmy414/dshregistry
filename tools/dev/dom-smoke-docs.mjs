...
assert(dd.getElementById('stat-plugins').textContent === '2439', `插件数 ("${dd.getElementById('stat-plugins').textContent}")`)
assert(dd.getElementById('stat-cats').textContent === '8', `分类数 ("${dd.getElementById('stat-cats').textContent}")`)
assert(dd.getElementById('stat-community').textContent === '70', `社区认可数 ("${dd.getElementById('stat-community').textContent}")`)
...
assert(friendLinks.length === 3, '友情链接 3 张卡')
...
assert(friendHrefs.includes('https://www.deepseek.com/'), 'DeepSeek 链接')
